...
# Directories
orig_dir = "S:\PROGRAMMES\Global_Pgeogs\Data\Figures\North America"
new_dir = "S:\PROGRAMMES\Globe_2021\ConfidencePolygons\PalaeoAtlases\Images\From GPgeogs Data\North America"
...
with open(home_path + "\\file_match_NA.csv", "wb") as f:
    writer = csv.writer(f)
    writer.writerows(match_files)

f.close()

print("File saved to %s\\file_match_NA.csv" % home_path)